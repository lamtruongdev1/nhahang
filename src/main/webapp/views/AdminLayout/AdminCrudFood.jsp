		...
		<section class="section">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">Food's Datatables</h5>
							<p>
								Quản lý món ăn nhà hàng <a
							...
							<div class="container" style="margin-top: 10px;">
								<div class="row"
									...
									<div class="col-sm-12">
										<h2>Food's Yum Great</h2>
										<form:form action="savefood" modelAttribute="menu" method="post"
											enctype="multipart/form-data">
											<div class="form-group">
												<label>ID</label>
												<form:input type="text" class="form-control" path="id"
													placeholder="Food's ID" />
											...
											<div class="form-group">
												<label>Photo</label> <input type="file" class="form-control"
													name="image" accept="image" placeholder="Photo" />
												<p class="errorPhoto">${errorPhoto}</p>
												<!-- <p> Bắt ERROR của Photo bằng input HTML ko bắt dc bằng form:form <input> </p>  -->
											</div>

											<div class="form-group">
												<label>Description:</label>
												<form:input type="text" class="form-control"
													path="description" placeholder="Discription?" />

											</div>
											
											<div class="form-group">
											<h4>Type</h4>
												<label for="normal">Normal</label> <input type="radio"
													id="normal" name="status" value="Normal"> <br>
											
												<label for="normal">Medium</label> <input type="radio"
													id="normal" name="status" value="Normal"> <br>
													
												
												<label for="normal">High</label> <input type="radio"
													id="normal" name="status" value="Normal"> <br>
